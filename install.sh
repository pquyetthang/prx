...
# --- BẮT ĐẦU SỬA ĐỔI ---
# Đã loại bỏ phần lựa chọn chế độ cấu hình và đặt mặc định là "Automatic"
config_mode="1"
# --- KẾT THÚC SỬA ĐỔI ---
...
# Function to get manual credentials for SOCKS5 (sẽ không được gọi do config_mode mặc định là "1")
...
# Function to get manual credentials for Shadowsocks (sẽ không được gọi do config_mode mặc định là "1")
